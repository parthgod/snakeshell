...
export const OrderReceivedEmail = ({ shippingAddress, orderId, orderDate }: OrderReceivedEmailProps) => {
  const baseUrl = process.env.NODE_ENV === "development" ? "http://localhost:300" : "https://snakeshell.vercel.app";
        ...
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={global.text}>
              We're preparing for delivery and will notify you once your package has been shipped. Delivery will take 5
              days.
            </Text>
          ...
          <Section style={paddingY}>
            ...
            <Row>
              <Text style={footer.text}>&copy; SnakeShell Inc. All rights reserved.</Text>
            </Row>
          </Section>
        </Container>
      </Body>
...
export const OrderReceivedEmailHtml = (props: OrderReceivedEmailProps) =>
  render(<OrderReceivedEmail {...props} />, {
    pretty: true,
  });
