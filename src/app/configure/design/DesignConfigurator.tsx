...
const DesignConfigurator = ({ imgDimensions, configId, imgUrl }: DesignConfiguratorProps) => {
                    ...
                    {COLORS.map((color) => (
                      <RadioGroup.Option
                        ...
                        className={({ active, checked }) =>
                          cn(
                            "relative -m-0.5 flex items-center justify-center rounded-full p-0.5 active:ring-0 focus:ring-0 active:outline-none focus:outline-none border-2 border-transparent",
                            {
