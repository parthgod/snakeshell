        ...
        <div className="mt-10 border-t border-zinc-200">
          <div className="mt-10 flex flex-auto flex-col">
            ...
            <p className="mt-2 text-sm text-zinc-600">
              We at snakeshell believe that a phone case doesn't only need to look good but also last you for years to
              come. We offer 5-year guarantee: If your case isn't of the highest quality, we'll replace it for free.
            </p>
          </div>
        </div>
